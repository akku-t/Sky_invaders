...
##Icon and Title
pygame.display.set_caption("Sky_Invaders")
...
#2 states.. Ready--> cant see bullet on scree
...
def game_over_text():
	...
	over = font.render("GAME OVER  ", True, (0,0,255))
...
while running:
	...
	# Boundry checking for spaceship ///out of bounds
